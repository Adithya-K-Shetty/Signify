...
public class ListFragment extends Fragment {
    ...
    private void signRecycle() {
        ...
        System.out.println("List Fragment Loaded.........");
        TellTailFragment tellTailFragment = new TellTailFragment();
        System.out.println(tellTailFragment.sign_data_list);
        for(int i = 0; i < tellTailFragment.sign_data_list.size();i++)
        {
            signloc.add(new SignHelper(tellTailFragment.sign_data_list.get(i).getImageUrl(),tellTailFragment.sign_data_list.get(i).getTitle(),tellTailFragment.sign_data_list.get(i).getDescription1(),tellTailFragment.sign_data_list.get(i).getDescription2(),tellTailFragment.sign_data_list.get(i).getSeverityValue()));
        }
        /*** End Of Testing ***/
